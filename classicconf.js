...
global.email = 'lejokair2@gmail.com' //serah
global.region = 'congodrc' // serah
//—————「 Set Nama Own & Bot 」—————//
global.ownername =lejokair 'ꪶ༺֎ᚏ༈࿉𝐀𝐍𝐎𝐍𝐘𝐌𝐎𝐔𝐒⧉ᚙ֎⸙༻' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['243843625334'] // ubah aja pake nomor lu
//==========================zetsuboclient=======================//
